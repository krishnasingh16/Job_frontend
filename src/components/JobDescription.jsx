  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
        ...
        onClick={isApplied? null : applyJobHandler}
          ...
          className={`rounded-lg ${
            isApplied
              ...
              : "bg-[#7209b7] hover:bg-[#a635f1]"
          }`}
        >
          {isApplied ? "Aleready Applied" : "Apply Now"}
        </Button>
      </div>
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Experience: <span className="p-4 font-normal text-gray-800">{singleJob?.experience}yrs</span></h1>
        <h1 className="font-bold my-1">Salary: <span className="p-4 font-normal text-gray-800">{singleJob?.salary}LPA</span></h1>
        <h1 className="font-bold my-1">Total Applicants: <span className="p-4 font-normal text-gray-800">{singleJob?.application?.length}</span></h1>
